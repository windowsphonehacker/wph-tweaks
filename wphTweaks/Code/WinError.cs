...
namespace CSharp___DllImport
{
    public enum WinError : long
    {
        ...
        E_ABORT = 0x80004004,
        E_FAIL = 0x80004005,
        E_UNSPEC = E_FAIL, /* must to be defined (used by FileMoniker, IOleLink and DoDragDrop as a return value) */
        ...
        DATA_S_SAMEFORMATETC = 0x80040130,
        ...
        MK_E_MIUSTBOTHERUSER = 0x800401EB,
        ...
        CLASSFACTORY_S_FIRST = 0x80040110L,
        CLASSFACTORY_S_LAST = 0x8004011FL,

        CLASS_E_NOTLICENSED = (0x80040110L + 2),
        //CLASS_E_NOAGGREGATION = 0x80040110,
        //CLASS_E_CLASSNOTAVAILABLE = 0x80040111,


        OLEOBJ_E_NOVERBS = 0x00040180L,
        OLEOBJ_E_INVALIDVERB = 0x00040181L,
